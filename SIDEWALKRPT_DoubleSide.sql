IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SIDEWALKRPT_DoubleSide]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SIDEWALKRPT_DoubleSide]
GO
...
CREATE PROCEDURE [dbo].[SIDEWALKRPT_DoubleSide]
	@SidewalkID integer,
	@FWSegID integer
